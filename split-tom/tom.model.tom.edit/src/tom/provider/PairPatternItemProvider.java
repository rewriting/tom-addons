...
/**
 * This is the item provider adapter for a {@link tom.PairPattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PairPatternItemProvider extends LinkableItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PairPatternItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TomPackage.Literals.PAIR_PATTERN__PATTERN);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PairPattern"));
	}
	...
	public String getText(Object object) {
		String label = ((PairPattern)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PairPattern_type") :
			getString("_UI_PairPattern_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PairPattern.class)) {
			case TomPackage.PAIR_PATTERN__PATTERN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.PAIR_PATTERN__PATTERN,
