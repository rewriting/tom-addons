...
/**
 * This is the item provider adapter for a {@link tom.ConditionP} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionPItemProvider extends ConditionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConditionPItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TomPackage.Literals.CONDITION_P__CONDITION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionP"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_ConditionP_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionP.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.CONDITION_P__CONDITION,
