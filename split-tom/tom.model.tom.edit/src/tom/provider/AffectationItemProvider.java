...
/**
 * This is the item provider adapter for a {@link tom.Affectation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AffectationItemProvider extends ExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TomPackage.Literals.AFFECTATION__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TomPackage.Literals.AFFECTATION__VALUE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Affectation.class)) {
			case TomPackage.AFFECTATION__VALUE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.AFFECTATION__VALUE,
