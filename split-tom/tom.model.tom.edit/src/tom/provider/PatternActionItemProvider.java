...
/**
 * This is the item provider adapter for a {@link tom.PatternAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternActionItemProvider extends ContextItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PatternActionItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TomPackage.Literals.PATTERN_ACTION__PATTERNS);
			childrenFeatures.add(TomPackage.Literals.PATTERN_ACTION__STATEMENTS);
		}
	...
	/**
	 * This returns PatternAction.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PatternAction"));
	}
	...
	public String getText(Object object) {
		String label = ((PatternAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PatternAction_type") :
			getString("_UI_PatternAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PatternAction.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.PATTERN_ACTION__PATTERNS,
				 TomFactory.eINSTANCE.createPatternList()));

		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.PATTERN_ACTION__STATEMENTS,
