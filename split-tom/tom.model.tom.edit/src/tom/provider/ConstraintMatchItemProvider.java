...
/**
 * This is the item provider adapter for a {@link tom.ConstraintMatch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintMatchItemProvider extends ConstraintItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConstraintMatchItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConstraintMatch_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConstraintMatch_type_feature", "_UI_ConstraintMatch_type"),
				 TomPackage.Literals.CONSTRAINT_MATCH__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TomPackage.Literals.CONSTRAINT_MATCH__PATTERN);
			childrenFeatures.add(TomPackage.Literals.CONSTRAINT_MATCH__TERM);
		}
	...
	/**
	 * This returns ConstraintMatch.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConstraintMatch"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_ConstraintMatch_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConstraintMatch.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.CONSTRAINT_MATCH__PATTERN,
		...
		newChildDescriptors.add
			(createChildParameter
				(TomPackage.Literals.CONSTRAINT_MATCH__TERM,
				 TomFactory.eINSTANCE.createTerm()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == TomPackage.Literals.CONSTRAINT_MATCH__PATTERN ||
			childFeature == TomPackage.Literals.CONSTRAINT_MATCH__TERM;
